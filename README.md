...
<!--
**Hafsa06rd/Hafsa06rd** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
*MSc Business Intelligence & Big Data Analytics · Arabic, French & English fluent*
...
I'm a data analyst with a background in **Business Intelligence & Big Data Analytics**, passionate about extracting meaningful patterns from complex datasets and translating them into clear, actionable insights.

My work spans the full analytics lifecycle, from raw data ingestion and SQL-based cleaning to exploratory analysis, statistical modeling, and interactive dashboards. I care about the *story behind the numbers* just as much as the numbers themselves.

I've worked with datasets across **healthcare, retail, energy, and entertainment**, giving me a broad perspective on how data challenges differ by domain, and how to adapt accordingly. Whether it's optimizing a SQL query, designing a Power BI dashboard, or building a churn prediction model, I focus on work that creates real business value.
...
- 🔭 I'm currently working on **expanding my portfolio with end-to-end analytics projects across different industries**
- 🌱 I'm currently learning **dbt for data transformation, MLflow for experiment and tracking**
...
![Statsmodels](https://img.shields.io/badge/Statsmodels-3D6B9B?style=for-the-badge&logo=python&logoColor=white)
...
###  Notebooks & Learning Logs
 Documented notebooks where I explore new techniques, reproduce results, or practice specific skills. Organized as learning artifacts, honest records of the work, not just polished outputs.
...
I write about data analytics, practical techniques, and the less-talked-about parts of working with data, from debugging a stubborn SQL join to explaining a model result to a non-technical stakeholder.

<!-- BLOG-POST-LIST:START -->
- 📌 *Coming soon : articles on EDA workflows, SQL patterns, and lessons from real projects*
<!-- BLOG-POST-LIST:END -->

 [Follow on Medium →](https://medium.com/@h.rouchdi6)
...
If you have an interesting problem that needs a data perspective, I'd love to hear about it.
...
<div align="center">
<sub>⭐ Starring repos you find useful helps more than you'd think -- thank you!</sub>
</div>
